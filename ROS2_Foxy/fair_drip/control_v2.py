...
async def beancup_dropbean_1(): #dripper1 수정
    await PTP(cf.set_coffee_bean_dripper1['J1'], 60, -1)
    await PTP(cf.set_coffee_bean_dripper1['J2'], 60, -1)
    await PTP(cf.set_coffee_bean_dripper1['J3'], 60, -1)
    await PTP(cf.set_coffee_bean_dripper1['J2'], 60, -1)
    await PTP(cf.set_coffee_bean_dripper1['J3'], 60, -1)
    await PTP(cf.set_coffee_bean_dripper1['J2'], 60, -1)
    await PTP(cf.set_coffee_bean_dripper1['J3'], 60, -1)
...
async def beancup_dropbean_2(): #수정       
    await PTP(cf.set_coffee_bean_dripper2['J1'], 60, -1)
    await PTP(cf.set_coffee_bean_dripper2['J2'], 60, -1)
    await PTP(cf.set_coffee_bean_dripper2['J3'], 60, -1)
    await PTP(cf.set_coffee_bean_dripper2['J2'], 60, -1)
    await PTP(cf.set_coffee_bean_dripper2['J3'], 60, -1)
    await PTP(cf.set_coffee_bean_dripper2['J2'], 60, -1)
    await PTP(cf.set_coffee_bean_dripper2['J3'], 60, -1)
...
async def beancup_dropbean_3(): #수정
    await PTP(cf.set_coffee_bean_dripper3['J1'], 60, -1)
    await PTP(cf.set_coffee_bean_dripper3['J2'], 60, -1)
    await PTP(cf.set_coffee_bean_dripper3['J3'], 60, -1)
    await PTP(cf.set_coffee_bean_dripper3['J2'], 60, -1)
    await PTP(cf.set_coffee_bean_dripper3['J3'], 60, -1)
    await PTP(cf.set_coffee_bean_dripper3['J2'], 60, -1)
    await PTP(cf.set_coffee_bean_dripper3['J3'], 60, -1)
...
async def shaking_dripper1():
    ...
    await PTP(cf.new_shaking_dripper1["J1"], 60, -1)
    await PTP(cf.new_shaking_dripper1["J2"], 60, -1)
    await PTP(cf.new_shaking_dripper1["J3"], 60, -1)
    await movegripper(1, 15, 50, 50, 10000, 0)
    await PTP(cf.new_shaking_dripper1["J4"], 60, -1)
    await PTP(cf.new_shaking_dripper1["J5"], 60, 500)
    await PTP(cf.new_shaking_dripper1["J6"], 60, 500)
    await PTP(cf.new_shaking_dripper1["J5"], 60, 500)
    await PTP(cf.new_shaking_dripper1["J6"], 60, 500)
    await PTP(cf.new_shaking_dripper1["J5"], 60, 500)
    await PTP(cf.new_shaking_dripper1["J6"], 60, 500)
    ...
    await PTP(cf.new_shaking_dripper1["J5"], 60, 500)
    await PTP(cf.new_shaking_dripper1["J6"], 60, 500)
    await PTP(cf.new_shaking_dripper1["J4"], 60, 100)
    await PTP(cf.new_shaking_dripper1["J3"], 60, -1)
    await movegripper(1, 100, 50, 50, 10000, 0)
    await PTP(cf.new_shaking_dripper1["J2"], 60, -1)
    await PTP(cf.new_shaking_dripper1["J1"], 60, -1)
